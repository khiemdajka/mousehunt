...
- [Ultimate Charm Farming Guide](#ultimate-charm-farming-guide)
  ...
  - [4. Other indirect event boosts](#4-other-indirect-event-boosts)
    - [4.1. Lunar New Year](#41-lunar-new-year)
    - [4.2. Spring Egg Hunt](#42-spring-egg-hunt)
...
## 4. Other indirect event boosts
### 4.1. Lunar New Year
- Using red candles to triple shattering boss chests, thus tripling [UC crafting materials](#12-crafting)
### 4.2. Spring Egg Hunt
- Using Eggstra Fondue (and maybe [Chocolate Base Base](https://www.mousehuntgame.com/item.php?item_type=chocolate_bar_base) too) to get 2.25 ***more*** [UC crafting materials](#12-crafting) per shattering boss (from [Shattered Egg](https://www.mousehuntgame.com/item.php?item_type=shattered_egg_convertible))